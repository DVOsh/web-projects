...
(0, _upload.upload)('#file', {
  ...
  onUpload: function onUpload(files, blocks) {
    ...
    files.forEach(function (file, index) {
      var _ref = (0, _storage.ref)(storage, "images/".concat(file.name));

      var task = (0, _storage.uploadBytesResumable)(_ref, file); // uploadBytes(_ref, file).then(snapshot => {
      ...
      task.on('state_changed', function (snapshot) {
        ...
        // })
        (0, _storage.getDownloadURL)((0, _storage.ref)(storage, "images/".concat(file.name))).then(function (url) {
          console.log('DownloadURL', url);
        });
      });
    });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "55038" + '/');
