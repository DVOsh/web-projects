...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    ...
    value: function clickHandler(event) {
      var type = event.target.dataset.type; // if (type === 'input' || event.target.closest('.select')) {
      // if (type === 'input' || event.target.closest('.select')) {
      // 	this.toggle()
      // } else if (type === 'item') {
    ...
    key: "open",
    value: function open() {
      this.$el.classList.add('open'); // this.$arrow.classList.remove('fa-chevron-down')
      // this.$arrow.classList.add('fa-chevron-up')
    }
  }, {
    key: "close",
    value: function close() {
      this.$el.classList.remove('open'); // this.$arrow.classList.remove('fa-chevron-up')
...
//# sourceMappingURL=/js-select-plugin.e31bb0bc.js.map